...
export default function TopCardAff({
  theme,
  user,
}: {
  theme: Theme;
          ...
          {loading ? (
            ...
            <View>
              <Aff
                ...
                lang={lang}
                dateKey={dateKey}
                getTodayAffirmationName={(currentLang: string) => {
                  switch (currentLang) {
                    case "kz":
                      return "Бүгінгі аффирмация";
                    case "en":
                      return "Affirmation for today";
                    case "tr":
                      return "Bugünün olumlaması";
                    default:
                      return "Твоя аффирмация дня";
                  }
                }}
              />
            </View>
